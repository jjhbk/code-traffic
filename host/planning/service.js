class PlanningService {
  ...
  async executeDecision({ decision, recipe, inputs = {}, grantId, taskId = null, taskVersion = decision?.taskVersion ?? null, principal = 'signal-box-user', surface = 'desktop', executor = null } = {}) {
    ...
    try {
      const result = await this.browserActions.executeWithStandingGrant(registeredRecipe, inputs, { grantId, principal, surface, taskId, taskVersion, executor: executor || undefined });
